...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/06 14:54:26 by asasada           #+#    #+#             */
/*   Updated: 2022/11/09 21:18:35 by asasada          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char *argv[])
{
	...
	mlx_hook(info.win, Expose, ExposureMask, draw_expose, &info);
	mlx_loop_hook(info.mlx, anim_counter, &info);
	mlx_loop(info.mlx);
	return (0);
}
